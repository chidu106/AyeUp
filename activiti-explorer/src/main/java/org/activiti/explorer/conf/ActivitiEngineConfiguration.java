...
public class ActivitiEngineConfiguration {
  ...
  public DataSource dataSource() { 
    ...
    // Connection settings
    ds.setUrl(environment.getProperty("jdbc.url", "jdbc:sqlserver://DATABASE-UAT:1433;databaseName=CHFT_Activiti"));
    ds.setUsername(environment.getProperty("jdbc.username", "activiti"));
    ds.setPassword(environment.getProperty("jdbc.password", "Activiti"));
